...
import { TopPerformerDetailsComponent } from './TopPerformerDetails';
            ...
            bg-consultancy-blue/10 text-consultancy-blue dark:bg-consultancy-accent/20 dark:text-cyan-300 ring-1 ring-inset ring-consultancy-blue/20">
                    ...
                    <div className="space-y-8 mt-12 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="space-y-4">
                                ...
                                {marketAnalysis.critical_updates && marketAnalysis.critical_updates.length > 0 && (
                                    <div className="glass-panel p-5 border-t-4 border-t-orange-500 bg-orange-50/50 dark:bg-orange-900/20">
                                        <h4 className="font-bold text-slate-900 dark:text-white mb-4 flex items-center gap-2">
                                            <Zap className="h-4 w-4 text-orange-500" />
                                            Critical Updates Needed
                                        </h4>
                                        <ul className="space-y-2">
                                            {marketAnalysis.critical_updates.map((update: string, i: number) => (
                ...
                {marketAnalysis?.topPerformer && (
                    <div className="mt-12 pt-12 border-t border-slate-200 dark:border-slate-800">
                        ...
                        <TopPerformerDetailsComponent
                            topPerformer={marketAnalysis.topPerformer}
                            userMaturity={category}
